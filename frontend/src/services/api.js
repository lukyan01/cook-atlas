...
export const userApi = {
  ...
  register: async (userData) => {
    try {
      const response = await api.post("users/auth/register", userData); // changed from /auth/register to users/auth/register * was unable to register user before *
  ...
  login: async (credentials) => {
    try {
      const response = await api.post("users/auth/login", credentials); // changed from /auth/login to users/auth/login
      return response.data;
    } catch (error) {
